...
export const myProjects = [
  ...
  {
    title: "Coop Dev",
    desc: "Este site foi desenvolvido para a Coop Dev, uma cooperativa de desenvolvedores que tem como objetivo promover a colaboração e o compartilhamento de conhecimento entre profissionais da área de tecnologia. O projeto foi construído com Angular e TailwindCSS, e destaca a importância da comunidade e do trabalho em equipe.",
    subdesc:
      "O site da Coop Dev é um exemplo prático de como a tecnologia pode ser usada para unir pessoas e promover a troca de experiências e ideias.",
    href: "https://coopdev.com.br/",
    texture: "/textures/project/coop-dev.png",
    logo: "/assets/coop-dev.png",
    logoStyle: {
...
export const workExperiences = [
  ...
  },
  {
    ...
    duration: "2024",
    title:
      "Como desenvolvedor Full Stack atuo na implementação de novas features, manutenção e correção de bugs em aplicações de médio e grande porte. Atuo com a metodologia scrum para organização de tarefas e comunicação com a equipe.",
